...
$.fn.myfunc = function (userPref) {
    ...
    this.defaultProperty = {
      ...
      numbH               : 18,          /**indicator number height*/
  ...
  $("#accelerating").myfunc({divFact:10,eventListenerType:'keyup'});
   $("#accelerating").attr("value", 0).trigger("keyup");
   $(document).on('keypress', function (e) {
       if (e.charCode == 113 || e.charCode == 119) {
           console.log('arranque!');
         $("#accelerating").attr("value", 180).trigger("keyup");
          setTimeout(function () {
            $("#accelerating").attr("value", 0).trigger("keyup");
          }, 1000);
       }
